...
//  
//  Running on Linux m112061603@ws34:10357 3.10.0-1160.95.1.el7.x86_64 x86_64 aol
//  
...
solution options set /Flows/SCVerify/INVOKE_ARGS {./image/people_gray.bmp 1 out_algorithm.bmp out_hw.bmp}
...
solution library add {[Block] EdgeDetect_IP::EdgeDetect_MagAng.v2}
...
directive set /EdgeDetect_IP::EdgeDetect_Top/EdgeDetect_IP::EdgeDetect_MagAng -MAP_TO_MODULE {[Block] EdgeDetect_IP::EdgeDetect_MagAng.v2}
go assembly
directive set /EdgeDetect_IP::EdgeDetect_Top/pix_chan1:cns -FIFO_DEPTH 0
directive set /EdgeDetect_IP::EdgeDetect_Top/pix_chan2:cns -FIFO_DEPTH 2
